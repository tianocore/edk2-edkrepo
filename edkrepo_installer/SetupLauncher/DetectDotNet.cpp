...
// Author has indicated that there is no license required to use this code.
//
...
bool CheckNetfxVersionUsingMscoree(const TCHAR *pszNetfxVersionToCheck)
{
	...
	HMODULE hmodMscoree = LoadLibraryEx(_T("mscoree.dll"), NULL, LOAD_LIBRARY_SEARCH_SYSTEM32);
	if (NULL != hmodMscoree)
	{
                     ...
                     int       nCmdShow)
{
	...
	// The .NET Framework 4.5, 4.5.1, 4.5.2, 4.6, 4.6.1, and 4.6.2 are in-place replacements for the .NET Framework 4.
