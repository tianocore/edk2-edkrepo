...
from edkrepo_manifest_parser.manifest_parser_unit_test_helpers.helpers import (
    ...
    PROJECT_XML_A,
    CI_UNKNOWN_PROJECT,
    ELEMENT_TAG_CI_PROJECT_LIST,
    CI_DEFAULT_XML_PATH,
    CI_PARAMETRIZE_FIELDS,
    ID_MIXED,
    ID_ALL_ARCHIVED,
    ID_NONE_ARCHIVED,
)

PROJECT_LIST_IDS          = [ID_MIXED, ID_ALL_ARCHIVED, ID_NONE_ARCHIVED]
ARCHIVED_PROJECT_LIST_IDS = [ID_MIXED, ID_NONE_ARCHIVED, ID_ALL_ARCHIVED]
...
class TestCiIndexXml:
    ...
    @pytest.mark.parametrize(CI_PARAMETRIZE_FIELDS, [
        (False, True,  [PROJECT1_NAME]),
        (True,  True,  []),
        (False, False, [PROJECT1_NAME, PROJECT2_NAME]),
    ...
    @pytest.mark.parametrize(CI_PARAMETRIZE_FIELDS, [
        (False, True,  [PROJECT2_NAME]),
        (False, False, []),
        (True,  True,  [PROJECT1_NAME, PROJECT2_NAME]),
    ], ids=ARCHIVED_PROJECT_LIST_IDS)
