...
from edkrepo_manifest_parser.edk_manifest import SubmoduleInitPath
from edkrepo_manifest_parser.edk_manifest import _parse_submodule_init_required_attribs
from edkrepo_manifest_parser.edk_manifest import _SubmoduleInitEntry
