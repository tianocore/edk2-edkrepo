                ...
                if stdout:
                    ...
                    if 'html_url' in results.keys():
                        ...
                        if 'number' in results.keys():
                            ...
                            if pr_number:
                                reviewer_list = ",".join(args.reviewers)
                                reviewer_array = reviewer_list.join(['[', ']'])
                                pr_url = '{}/{}/requested_reviewers'.format(pr_create_url, pr_number)
                                ...
                                stdout, stderr = reviewer_process.communicate()
